...
def main():
    ...
    # We store a ckp in /checkpoints when the attack is done
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Apply a candidate method for attack"
    )
    parser.add_argument(
        "--search-method",
        "-s",
    ...
    # set None when you run untarget_attack.py! 
    # set checkpoint path if you want to get a summary and results of this attack.
    parser.add_argument(
        "--checkpoint-path",
        "-ckp",
        type=str,
